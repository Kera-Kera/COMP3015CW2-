...
private:
    ...
    void mainLoop(GLFWwindow * window, Scene & scene) {
        while( ! glfwWindowShouldClose(window) && !glfwGetKey(window, GLFW_KEY_ESCAPE) ) {
            ...
            int currentButton1 = glfwGetKey(window, GLFW_KEY_1);
            int currentButton2 = glfwGetKey(window, GLFW_KEY_2);
            int currentButton3 = glfwGetKey(window, GLFW_KEY_3);
            int currentButton4 = glfwGetKey(window, GLFW_KEY_4);
            scene.getButtonPress(currentButton1, currentButton2, currentButton3, currentButton4);
